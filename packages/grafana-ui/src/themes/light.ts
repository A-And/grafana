...
const lightTheme: GrafanaTheme = {
  ...
  colors: {
    ...
    dark1: azureColors.black,
    greenBase: azureColors.blue,
    greenShade: azureColors.blueLight,
    gray5: azureColors.grayLight,
    gray6: new tinycolor(azureColors.grayLight).lighten(80).toString(),
    //
    variable: azureColors.blue,
    inputBlack: '#09090b',
    queryRed: basicColors.red,
    queryGreen: basicColors.greenDefault,
    queryPurple: basicColors.purple,
    queryKeyword: basicColors.blue,
    queryOrange: basicColors.blue,
    online: basicColors.greenShade,
    warn: '#f79520',
    critical: basicColors.redShade,
    bodyBg: basicColors.gray7,
    pageBg: basicColors.gray7,
    bodyColor: azureColors.blueLight,
    textColor: azureColors.blueLight,
    textColorStrong: basicColors.dark2,
    textColorWeak: basicColors.gray2,
    textColorEmphasis: basicColors.gray5Default,
    textColorFaint: basicColors.dark4,
    linkColor: azureColors.blueLight,
    linkColorDisabled: new tinycolor(azureColors.blueLight).lighten(30).toString(),
    linkColorHover: new tinycolor(azureColors.blueLight).darken(20).toString(),
    linkColorExternal: basicColors.blueLight,
    headingColor: azureColors.blueLight,
  },
  background: {
    dropdown: basicColors.white,
    scrollbar: basicColors.gray5Default,
    scrollbar2: basicColors.gray5Default,
  },
};
